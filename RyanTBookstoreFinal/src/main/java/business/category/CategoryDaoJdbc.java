...
public class CategoryDaoJdbc implements CategoryDao {
    ...
    public Category findByName(String name) {
        ...
        // TODO: Finish implementing this method (we get a single category returned)
        //NOTE in instructions: If more than one category has that name, it can return any one of them. Don't return a list (just the first one it finds)
        //changes are that I added the setString to take in the string name to the first parameter in the question mark
        try (Connection connection = JdbcUtils.getConnection();
