...
public class JdbcUtils {
	...
	// TODO Replace "DrK" with your assigned name; even in instructions: business.JdbcUtils (TODO: Change "DrK" to *your* name)
    //both the bookDao and CategoryDao import this business.JdbcUtils and use it to establish connections for SQL queries with the database
    private static final String JDBC_BOOKSTORE = "jdbc/RyanTBookstore";
